...
!function (t) {
    ...
    var r, o, n, i, s, l, u, h, a, c, p, d, f, g, y, v, m, w, R, b, S, C, E, _, H, T, I, D, x, F, G, W, M, B, L, k, z, A, V, P, O, q, N, j, Y, U, X, $, K, Q, J, Z, tt, et, rt, ot, nt, it, st, lt, ut,
        ht, at, ct, pt, dt, ft, gt, yt, vt, mt, wt, Rt, bt, St, Ct, Et, _t, Ht, Tt, It, Dt, xt, Ft, Gt, Wt, Mt, Bt, Lt, kt, zt = [].slice, At = function (t, e) {
            function r() {
                this.constructor = t
            }
    ...
    return c = t.fullCalendar, c.schedulerVersion = "1.2.1", 3 !== c.internalApiVersion ? void c.warn("v" + c.schedulerVersion + " of FullCalendar Scheduler is incompatible with v" + c.version + " of the core.\nPlease see http://fullcalendar.io/support/ for more information.") : (o = c.Calendar, i = c.Class, j = c.View, p = c.Grid, gt = c.intersectRanges, tt = c.debounce, mt = c.isInt, ct = c.getScrollbarWidths, u = c.DragListener, ft = c.htmlEscape, $ = c.computeIntervalUnit, xt = c.proxy, U = c.capitaliseFirstLetter, Y = c.applyAll, h = c.Emitter, it = c.durationHasTime, nt = c.divideRangeByDuration, ot = c.divideDurationByDuration, bt = c.multiplyDuration, It = c.parseFieldSpecs, X = c.compareByFieldSpecs, st = c.flexibleCompare, yt = c.intersectRects, s = c.CoordCache, lt = function (t) {
        ...
        return t.prototype.axis = null, t.prototype.scrollers = null, t.prototype.masterScroller = null, t.prototype.enabled = !0, t.prototype.enable = function () {
            ...
            for (a = this.scrollers, e = o = 0, i = a.length; i > o; e = ++o)c = a[e], p = t[e], c.setGutters("horizontal" === this.axis ? {left: l - p.left, right: u - p.right} : {
                top: h - p.top,
                bottom: s - p.bottom
            })
        }, t
        ...
        function e(t) {
            this.scroller = t, this.sprites = [], this.scroller.on("scrollStart", function (t) {
                ...
                return function (e, r) {
                    var o, n, i;
                    return n = t.scroller.scrollEl, o = at(n), i = n.scrollTop(), t.viewportRect = {left: o, right: o + n[0].clientWidth, top: i, bottom: i + n[0].clientHeight}, t.updatePositions()
                }
            }(this))
        }
        ...
        return e.prototype.scroller = null, e.prototype.scrollbarWidths = null, e.prototype.sprites = null, e.prototype.viewportRect = null, e.prototype.contentOffset = null, e.prototype.isHFollowing = !0, e.prototype.isVFollowing = !1, e.prototype.containOnNaturalLeft = !1, e.prototype.containOnNaturalRight = !1, e.prototype.shouldRequeryDimensions = !1, e.prototype.minTravel = 0, e.prototype.isForcedAbsolute = !1, e.prototype.isForcedRelative = !1, e.prototype.setSprites = function (e) {
            ...
            var e, r, o;
            return r = t.offset(), e = r.left - this.contentOffset.left, o = r.top - this.contentOffset.top, {left: e, right: e + t.outerWidth(), top: o, bottom: o + t.outerHeight()}
        }, e
    }(), k = function () {
        function t(t, e) {
        ...
        return {left: Math.min(t.left, e.left), right: Math.max(t.right, e.right), top: Math.min(t.top, e.top), bottom: Math.max(t.bottom, e.bottom)}
    }, n = function (e) {
        function r() {
        ...
        flattenedResources: null, resourceCnt: 0, datesAboveResources: !1, allowCrossResource: !1, setResources: function (t) {
        ...
        return At(o, r), o.prototype.slotDates = null, o.prototype.slotCnt = null, o.prototype.snapCnt = null, o.prototype.snapsPerSlot = null, o.prototype.snapDiffToIndex = null, o.prototype.snapIndexToDiff = null, o.prototype.headEl = null, o.prototype.slatContainerEl = null, o.prototype.slatEls = null, o.prototype.containerCoordCache = null, o.prototype.slatCoordCache = null, o.prototype.slatInnerCoordCache = null, o.prototype.headScroller = null, o.prototype.bodyScroller = null, o.prototype.joiner = null, o.prototype.follower = null, o.prototype.eventTitleFollower = null, o.prototype.minTime = null, o.prototype.maxTime = null, o.prototype.timeWindowMs = null, o.prototype.slotDuration = null, o.prototype.snapDuration = null, o.prototype.duration = null, o.prototype.labelInterval = null, o.prototype.headerFormats = null, o.prototype.isTimeScale = null, o.prototype.largeUnit = null, o.prototype.emphasizeWeeks = !1, o.prototype.titleFollower = null, o.prototype.segContainerEl = null, o.prototype.segContainerHeight = null, o.prototype.bgSegContainerEl = null, o.prototype.helperEls = null, o.prototype.innerEl = null, o.prototype.opt = function (t) {
            ...
            var e, r;
            return r = this.start.clone(), r.add(bt(this.snapDuration, this.snapIndexToDiff[t])), e = r.clone().add(this.snapDuration), {start: r, end: e}
            ...
            for (g = this.labelInterval, i = this.headerFormats, e = function () {
                ...
                for (r = M[p], L = r.week(), c = this.emphasizeWeeks && null !== I && I !== L, x = d = 0, m = i.length; m > d; x = ++d)n = i[x], F = e[x], y = F[F.length - 1], a = i.length > 1 && x < i.length - 1, H = null, a ? (B = r.format(n), o = r.format(), y && y.text === B ? y.colspan += 1 : H = {
                    ...
                    dateData: o,
                    colspan: 1
                }) : !y || mt(nt(this.start, r, g)) ? (B = r.format(n), o = r.format(), H = {text: B, dateData: o, colspan: 1}) : y.colspan += 1, H && (H.weekStart = c, F.push(H));
            ...
            return this.isRTL ? {right: this.dateToCoord(t.start), left: this.dateToCoord(t.end)} : {left: this.dateToCoord(t.start), right: this.dateToCoord(t.end)}
            ...
            var r, o;
            return r = 0, this.isTimeScale && (o = this.opt("scrollTime"), o && (o = e.duration(o), r = this.dateToCoord(this.start.clone().time(o)))), {left: r, top: 0}
        ...
        return [].concat(t || [], e || [], r || [])
    }, c.views.timeline = {"class": O, defaults: {eventResizableFromStart: !0}}, c.views.timelineDay = {type: "timeline", duration: {days: 1}}, c.views.timelineWeek = {
        type: "timeline",
        duration: {weeks: 1}
    }, c.views.timelineMonth = {type: "timeline", duration: {months: 1}}, c.views.timelineYear = {type: "timeline", duration: {years: 1}}, F = function (e) {
        function r() {
            return r.__super__.constructor.apply(this, arguments)
        }
        ...
        return true;//Boolean(t.match(/\w+\:\/\/fullcalendar\.io\/|\/demos\/[\w-]+\.html$/))
    },Ft = function (e, r) {
        return r;//.append(t('<div class="fc-license-message" />').html(e))
    },void(rt = function (t) {
        return false;// t.find(".fc-license-message").length >= 1
    }))
});