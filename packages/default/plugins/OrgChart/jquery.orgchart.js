  ...
  OrgChart.prototype = {
    ...
    export: function (exportFilename, exportFileextension) {
      ...
      html2canvas(sourceChart, {
        'width': flag ? $(sourceChart).outerHeight() + 80 + $(sourceChart).offset().top : $(sourceChart).outerWidth() + $(sourceChart).offset().left,
        'height': flag ? $(sourceChart).outerWidth() + $(sourceChart).offset().left: $(sourceChart).outerHeight() + 80 + $(sourceChart).offset().top,
