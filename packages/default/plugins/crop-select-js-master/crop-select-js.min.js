...
!function ($) {
    ...
    this.wrapper = this.elem.find(".crop-wrapper"), this.wrapper[0] ? this.wrapper.detach() : this.wrapper = $("<div class='crop-wrapper'></div>")[0]
    ...
    this.cropImage = this.elem.find(".crop-image"), this.cropImage[0] ? this.cropImage.detach() : this.cropImage = $("<img class='crop-image' />")[0], $(this.wrapper).append(this.cropImage)
    ...
    if (this.selectionMouseStartX && this.selectionMouseStartY) {
        var changeX = e.pageX - this.selectionMouseStartX, changeY = e.pageY - this.selectionMouseStartY;
    ...
    if (0 != changeInWrapperWidth || 0 != changeInWrapperHeight) {
        var previousImageXScaleFactor = this.getImageWidth() / this.previousWrapperWidth,
            ...
            newImageXScaleFactor = this.getImageXScaleFactor(), newImageYScaleFactor = this.getImageYScaleFactor(),
    ...
    var newHeight, newWidth, calculatedHeight = Math.min(this.selectionStartHeight - changeY, maxHeight),
        ...
        aspectCalculatedWidth = calculatedHeight * aspectRatio, aspectCalculatedHeight = calculatedWidth / aspectRatio;
    ...
    var actualChangeInWidth = newWidth - this.selectionStartWidth,
        actualChangeInHeight = newHeight - this.selectionStartHeight, newX = this.selectionStartX - actualChangeInWidth,
    ...
    var maxHeight = this.selectionStartY + this.selectionStartHeight,
        maxWidth = this.selectionStartX + this.selectionStartWidth,
        newHeight = Math.min(this.selectionStartHeight - changeY, maxHeight), newWidth = newHeight * aspectRatio;
    ...
    var maxHeight = this.getWrapperHeight() - this.selectionStartY,
        ...
        newWidth = Math.min(this.selectionStartWidth + changeX, maxWidth), newHeight = newWidth / aspectRatio;
    ...
    var newHeight, newWidth, calculatedWidth = Math.min(this.selectionStartWidth - changeX, maxWidth),
        ...
        aspectCalculatedWidth = calculatedHeight * aspectRatio, aspectCalculatedHeight = calculatedWidth / aspectRatio;
    calculatedWidth > aspectCalculatedWidth ? (newWidth = calculatedWidth, newHeight = aspectCalculatedHeight) : (newHeight = calculatedHeight, newWidth = aspectCalculatedWidth);
    var actualChangeInWidth = newWidth - this.selectionStartWidth, newX = this.selectionStartX - actualChangeInWidth;
    ...
    var maxHeight = this.selectionStartY + this.selectionStartHeight,
        maxWidth = this.selectionStartX + this.selectionStartWidth,
        newWidth = Math.min(this.selectionStartHeight - changeX, maxWidth), newHeight = newWidth / aspectRatio;
    ...
    var wrapperWidth = this.getWrapperWidth(), cropSelectionWidth = this.getSelectionBoxWidth();
    ...
    var wrapperHeight = this.getWrapperHeight(), cropSelectionHeight = this.getSelectionBoxHeight();
    ...
    var width, height, wrapperWidth = this.getWrapperWidth(), wrapperHeight = this.getWrapperHeight(),
        aspectCalculatedWidth = wrapperHeight * aspectRatio, aspectCalculatedHeight = wrapperWidth / aspectRatio;
    ...
    var x = Math.floor((wrapperWidth - width) / 2), y = Math.floor((wrapperHeight - height) / 2);
