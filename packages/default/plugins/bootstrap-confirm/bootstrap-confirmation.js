+function ($) {
			...
			if(that.isPopout()) {
				if(!event_body) {
					event_body = $('body').on('click', function (e) {
						...
						if(that.$element == null || that.$element.is(e.target)) return;
	...
	Confirmation.DEFAULTS = $.extend({}, $.fn.popover.Constructor.DEFAULTS, {
		placement 		: 'right',
		title 			: 'Are you sure?',
		//btnOkClass 		: 'btn btn-sm btn-primary mgr10',
		btnOkClass 		: 'btn btn-sm btn_custom mgr10',
		btnOkLabel 		: 'Yes',
		//btnOkIcon 		: '',
		//btnOkIcon 		: 'glyphicon glyphicon-ok',
		//btnCancelClass 	: 'btn btn-sm btn-danger',
		btnCancelClass 	: 'btn btn-sm btn_custom',
		btnCancelLabel 	: 'No',
		//btnCancelIcon 	: '',
