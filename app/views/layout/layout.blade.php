...
<head>
    ...
    <link href="{{asset("packages/default/plugins/paramquery-3.3.4/pqSelect/pqselect.min.css")}}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{asset("packages/default/plugins/digi-contextmenu/digi-contextmenu.css")}}" rel="stylesheet" type="text/css"/>
    <!-- orgchart -->
    <link href="{{asset("packages/default/plugins/OrgChart/jquery.orgchart.css")}}" rel="stylesheet" type="text/css"/>
    <link href="{{url('packages/default/plugins/cropperjs/cropper.css')}}" rel="stylesheet">
    <!-- dropDownTreeView -->
    ...
    <link href="{{asset("packages/default/plugins/DevExtreme/dx.light.css")}}"  rel="dx-theme" data-theme="generic.light" type="text/css"/>
    <link href="{{asset("packages/default/plugins/DropDownTreeView/DropDownTreeView.css")}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset("packages/default/plugins/autocomplete/jquery.auto-complete.css")}}" rel="stylesheet" type="text/css"/>
    ...
    @include('layout.component.custom-style')
</head>
...
<div class="wrapper">
    ...
    @if(Auth::user()->check())
        @include('layout.component.headeraside_default')
...
<script src="{{url('packages/default/plugins/cropperjs/cropper.js')}}"></script>
...
<!-- dropdown search paramquery -->
<script src="{{asset("packages/default/plugins/paramquery-3.3.4/pqSelect/pqselect.min.js")}}" type="text/javascript"></script>
...
<script src="{{asset("packages/default/plugins/DropDownTreeView/DropDownTreeView.js")}}" type="text/javascript"></script>

<!-- AutoComplete -->
<script src="{{asset("packages/default/plugins/autocomplete/jquery.auto-complete.js")}}" type="text/javascript"></script>
