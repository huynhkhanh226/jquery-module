<div class="row">
    <div class="col-md-12 col-xs-12">
        <div id="pqgrid_W90F0120_2" style="margin:auto;"></div>
    </div>
</div>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function calculateSummary() {
            ...
            var summaryData = {CorAccountID:"", CorAccountName:"", DebitCAmount:"<b>"+format2(periodDebit, "", '{{Session::get("W91P0000")['D90_ConvertedDecimals']}}')+"</b>", CreditCAmount:"<b>"+format2(periodCredit, "", '{{Session::get("W91P0000")['D90_ConvertedDecimals']}}')+"</b>"};
            return [summaryData];
        }

        var $grid = $("#pqgrid_W90F0120_2").pqGrid(obj);
