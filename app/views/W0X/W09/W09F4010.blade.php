    ...
    <div class="modal-dialog formduyet">
        <div class="modal-content">
            <div class="modal-header logodg pdl0">
                {{Helpers::generateHeading(Helpers::getRS($g, 'Danh_sach_dinh_kem'),"W09F4010")}}
            </div>
...
<script type="text/javascript">
    ...
    var objGridW09F4010 = {
        ...
        @if($formCall == 'W38F2000' || $formCall == 'W09F2190')
        toolbar: {
            items: [
                {
                    type: 'button',
        ...
        @endif
        colModel: [
            @if($formCall == 'W38F2000')
            {
                title: "", editable: false, minWidth: 80, sortable: false, align: "center", isExport: false,
                render: function (ui) {
                    var rowData = ui.rowData;
                    var str = "";
                    str += "<a title='{{Helpers::getRS($g,"Xem")}}' class='btnViewW09F4010 mgr10'><i class='fa fa-eye' style='color:#2779aa'></i></a>";
                    str += "<a title='{{Helpers::getRS($g,"Sua")}}' class='btnEditW09F4010 mgr10'><i class='glyphicon glyphicon-edit' style='color:orange'></i></a>";
                    str += "<a title='{{Helpers::getRS($g,"Xoa")}}' class='btnDeleteW09F4010'><i class='fa fa-trash' style='color:#333'></i></a>";
                    return str;
                },
