<div class="modal draggable fade modal" id="modalW76F2090" data-keyboard="false" data-backdrop="static" role="dialog">
    <div class="modal-dialog" style="width: 90%">
        ...
        <div class="modal-content">
            <div class="modal-header">
                {{Helpers::generateHeading(Helpers::getRS($g,'Cap_nhat_cong_van_den'),"W76F2090",true,"")}}
            </div>
            <div class="modal-body">
                <div class="box-body">
                    <form id="frmW76F2090" class="form-horizontal">
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                ...
                                {{--</select>--}}
                                <input type="text" class="form-control text-uppercase" name="txtDivisionIDW76F2090"
                                       readonly="true"
                                       id="txtDivisionIDW76F2090" value="{{$DivisionID}}" placeholder=""
                                       required="">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtDocNoW76F2090"
                                       readonly="true"
                                       id="txtDocNoW76F2090" value="{{$DocNo}}" placeholder=""
                                       required="">
                            </div>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtDocGroupIDW76F2090"
                                       readonly="true"
                                       id="txtDocGroupIDW76F2090" value="{{$DocGroupID}}" placeholder=""
                                       required="">
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase"
                                       name="txtReceiveSendOrganizationW76F2090"
                                       readonly="true"
                                       id="txtReceiveSendOrganizationW76F2090" value="{{$ReceiveSendOrganization}}"
                                       placeholder=""
                                       required="">
                            </div>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtReleaseDateW76F2090"
                                       readonly="true"
                                       id="txtReleaseDateW76F2090" value="{{$ReleaseDate}}" placeholder=""
                                       required="">
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtSignerW76F2090"
                                       readonly="true"
                                       id="txtSignerW76F2090" value="{{$Signer}}" placeholder=""
                                       required="">
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtEffectDateFromW76F2090"
                                       readonly="true"
                                       id="txtEffectDateFromW76F2090" value="{{$EffectDateFrom}}" placeholder=""
                                       required="">
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtEffectDateToW76F2090"
                                       readonly="true"
                                       id="txtEffectDateToW76F2090" value="{{$EffectDateTo}}" placeholder=""
                                       required="">
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtEmergencyW76F2090"
                                       readonly="true"
                                       id="txtEmergencyW76F2090" value="{{$Emergency}}" placeholder=""
                                       required="">
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtSecurityW76F2090"
                                       readonly="true"
                                       id="txtSecurityW76F2090" value="{{$Security}}" placeholder=""
                                       required="">
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtDocTypeW76F2090"
                                       readonly="true"
                                       id="txtDocTypeW76F2090" value="" placeholder=""
                                       required="">
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control text-uppercase" name="txtQuanPageW76F2090"
                                       readonly="true"
                                       id="txtQuanPageW76F2090" value="" placeholder=""
                                       required="">
                            </div>
                        </div>
                        <div class="row form-group">
...
<script>
    ...
    $(document).ready(function () {
        iW76F2090Height = $(".contenttab").height() - 20;
        var obj = {
            //width: 100,
            height: iW76F2090Height,
            resizable: true,
            dataType: "JSON",
            editable: false,
            showTitle: false,
