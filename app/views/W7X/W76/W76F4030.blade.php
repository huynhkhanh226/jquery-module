<div class="modal fade pd0" id="modalW76F4030" data-backdrop="static" role="dialog">
    <div id="test" class="modal-dialog" style="width:80%;">
        <div class="modal-content">
            <div class="modal-header logodg pdl0">
                {{Helpers::generateHeading($caption,"W76F4030")}}
            </div>
            <div class="modal-body" style="height:450px;">
                ...
                <div class="row" style="bottom:-10px;position: absolute;right: 13px">
                    <div class="col-md-12">
                        <div id="pagW76F4030" class="pull-right"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function callShowImageList(id, albumName) {
        $.ajax({
            ...
            success: function (data) {
                $("#secViewW76F4031").html(data);
                $("#modalW76F4031").modal("show");
            }
        });
    }
    var bNewW76F4030 = false;
    $(document).ready(function () {
        filterPaging($("#modalW76F4030").find("#txtfilter").val());
        bNewW76F4030 = true;
    });

    $("#modalW76F4030").on('keyup', "#txtfilter", function (e) {
        bNewW76F4030 = false;
    ...
    function filterPaging(sfilter) {
        ...
        if (pg > 1) {
            $('#pagW76F4030').removeClass('hide');
            if ($('#pagW76F4030').data("twbs-pagination"))
                $('#pagW76F4030').twbsPagination('destroy');
            $('#pagW76F4030').twbsPagination({
                totalPages: pg,
                visiblePages: 8,
