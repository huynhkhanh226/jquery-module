<div id="W76F2100_Grid"></div>
<script type="text/javascript">
    $(document).ready(function () {
        iW76F2100Height = $(".contenttab").height() - 120;
        var dataSource = {{$rsFilter}};
        var obj = {
            width: "100%",
            height: $("#divD76F2100_W76F2100_W76F2100").height() - 150,
            resizable: true,
            dataType: "JSON",
            editable: false,
            showTitle: false,
        ...
        obj.colModel = [

            {
                ...
                postRender: function (ui) {
                    ...
                    $cell.find(".btnViewW76F2100").bind("click", function (evt) {

                        showFormDialogPost("{{url('/W76F2101/'.$pForm.'/'.$g.'/view')}}", "modalW76F2101", {
                            ID: rowData['ID']


                        });
                    });
                    $cell.find(".btnEditW76F2100").bind("click", function (evt) {

                        showFormDialogPost("{{url('/W76F2101/'.$pForm.'/'.$g.'/edit')}}", "modalW76F2101", {
                            ID: rowData['ID']
                        });
                    });
                    $cell.find(".btnDeleteW76F2100").bind("click", function (evt) {
                        //alert("QUYEN Delete");
                        ask_delete(function () {
                            postMethod("{{url('/W76F2100/view/'.$pForm.'/'.$g.'/delete')}}", function (res) {
                                var data = JSON.parse(res);
                                switch (data.status) {
                                    case "SUC":
                                        var $grid = $("#W76F2100_Grid");
                                        delete_ok(function () {
            ...
            {
                title: "{{Helpers::getRS($g, 'Co_quan_nhan')}}",
                width: 200,
                dataType: "string",
                align: "left",
                maxWidth: 300,
        ...
        var $grid = $("#W76F2100_Grid").pqGrid(obj);
